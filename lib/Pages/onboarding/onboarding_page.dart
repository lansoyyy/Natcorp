  ...
  final List<Map<String, dynamic>> splashData = [
    {
      "title": "OUTSOURCING",
      "subtitle":
          "Where the entire business process is outsourced where the duration of the contract is co terminus with the existence of the process.",
    ...
    },
    {
      ...
      "subtitle":
          "Assignment of people on project based engagements whose contract length will be co terminus with the project for which the employee was hired.",
    ...
    },
    {
      ...
      "subtitle":
          "Development of qualified people in various functionson contractual basis designed to augment increase in personnel requirement for the short term.",
